...
if (!source.includes(functionAnchor)) {
  throw new Error('Guard failed: artwork/page probe anchor not found exactly; no changes written.');
}
...
console.log('Added read-only TIDAL playlist relationship-page probe.');
